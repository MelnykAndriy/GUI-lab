describe("Profile Page", () => {
  ...
  //                 cy.get('button[aria-label="Edit date of birth"]').should('be.visible');
  //             });
  //     });
  ...
  //             cy.get('button').contains('Upload Avatar')
  //                 .should('be.visible')
  //                 // .and('have.class', 'sm')
  ...
  //             cy.get('button').contains('Change avatar color')
  //                 .should('be.visible')
  //         });
  //     });
  ...
  //             cy.contains('2025-06-03').should('be.visible');
  //         });
  //     });
  ...
  //             cy.contains('Date of Birth').parent().contains('N/A').should('be.visible');
  ...
  describe("Avatar Management", () => {
    ...
    it("should allow uploading a new avatar", () => {
      ...
      cy.get<string>("@testImage").then((testImage) => {
        ...
        cy.intercept("POST", "http://localhost:8000/api/users/avatar/", {
          statusCode: 200,
          body: {
        ...
        cy.contains("Uploading your avatar...").should("be.visible");
    ...
    it("should validate avatar file type and size", () => {
      ...
      cy.fixture("large-image.jpg").then((largeImage) => {
        const largeBlob = new Blob(
          [Cypress.Blob.base64StringToBlob(largeImage, "image/jpeg")],
          {
            type: "image/jpeg",
          },
        );
    ...
    it("should allow selecting avatar color when no image is uploaded", () => {
      ...
      // Open color dropdown
      cy.get("button").contains("Select color").click();
